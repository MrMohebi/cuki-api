...
if( ($_POST['token'] == $TOKEN_ADMIN) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['english_name']) && ($_POST['english_name'] != "")){
    ...
    $sql_create_new_restaurant = "INSERT INTO 
                                restaurants(`username`, `password`, `persian_name`, `english_name` ,`phone`, `db_name`, `payment_key`, `modified_date` )
                                VALUES('$username', '$hashed_password', '$persian_name', '$english_name', '$phone', '$db_name', '$payment_key', '$nowTimestamp');";
