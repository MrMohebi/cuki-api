...
if(isset($_POST['token'])){
    ...
    $sqlUpdateResInfoParams = array(
        ...
        "status"=> strlen($status) > 2 ? $status : $previousResInfo["status"],
        ...
        "employers"=> is_array($employers) && count($employers) > 0 ? json_encode($employers) : $previousResInfo["employers"],
        "social_links"=> is_array($socialLinks) && count($socialLinks) > 0  ? json_encode($socialLinks) : $previousResInfo["social_links"],
